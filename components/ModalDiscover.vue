...
<template>
  <Teleport to="body">
    <transition name="fade">
      <div v-if="props.visible" class="fixed inset-0 bg-accent z-20">
        <div class="container mx-auto py-6 px-4 h-full flex flex-col">
...
.fade-enter-active,
.fade-leave-active {
  @apply transition-all opacity-100 duration-200;
}
