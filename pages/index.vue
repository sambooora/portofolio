...
<template>
  <div class="">
    ...
    >
      <div
        class="container mx-auto px-4 md:px-8 pt-24 text-white flex-1 flex flex-col items-start justify-center"
      >
    ...
    >
      <div class="md:w-1/2 prose-md xl:prose-xl text-left gap-3 flex flex-col">
        ...
        <p>
          Hello, my name is Richie and I am a programmer. I have two years of experience in this
          field and have developed web applications for various companies. I am highly skilled in
          programming languages such as Javascript and PHP and always eager to learn new ones. I
          believe that technical skills should be accompanied by the ability to work well in a team
          and solve problems creatively. I am excited to work with you and open to further
          developing my skills alongside your team.
        </p>
      </div>
      <div class="w-full md:flex-1 flex items-center justify-center overflow-hidden">
        <img
          data-aos="fade-up"
          src="/images/discov-1.png"
          class="hidden md:block grayscale w-full h-full object-center object-contain"
        />
        <img
          data-aos="fade-up"
          data-aos-delay="300"
        ...
        <div data-aos="fade-left" class="flex flex-col justify-start gap-3">
          ...
          <div>
            ...
            >
              ...
              <div class="collapse-content">
                <p>
                  ...
                  user experiences. Worked in agile environments, contributing to continuous
                  improvement and deployment pipelines.
                </p>
              </div>
            </div>
            <div></div>
            ...
            >
              ...
              <div class="collapse-content">
                <p>
                  I worked on web design projects including the responsiveness for the mobile
                  version. Normally we do the kickoff meeting first and I get a rough wireframe from
                  the Project Manager, then I create the mockup. Got feedback and iterate. When the
                  mockup is final I convert it into HTML and SCSS. Working as a designer and
                  frontend developer makes me know which design is effective and which one is not
          ...
          <div>
            ...
            >
              ...
              <div class="collapse-content">
                <p>
                  Do Maintenance and Analytical Troubleshooting of film equipment (Projector, Server
                  and Sound System), Do Maintenance and Troubleshooting Hardware and Software IT
                  Assets of the company. Collecting IT Assets and Projectionists. Management of
                  company Networking (Routing, Switching, and Firewall Settings)
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="container mx-auto px-4 py-24 min-h-screen">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-6">
        <div class="flex flex-col space-y-4">
          ...
          <p class="text-lg">
            is a website to manage hotel back office such as reservation, campaign management and
            accounting
          </p>
        </div>
        <div class="flex flex-col space-y-4">
          ...
          <p class="text-lg">
            Is a website to online menus and ordering restaurant food. to shorten the queue that
            occurs at the restaurant
          </p>
        </div>
        <div class="flex flex-col space-y-4">
          <div
          ...
          <p class="text-lg">
            Is a website that aims to be a hotel landing page and promotion center
          </p>
        </div>
      </div>
    </section>
