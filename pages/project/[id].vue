...
const formattedIndex = computed(() =>
  productIndex.value !== null ? String(productIndex.value).padStart(2, '0') : '--'
)
...
<template>
  <div>
    ...
    <template v-if="!product">
      ...
      >
        ...
        <div class="relative z-10 text-center px-5">
          <span class="mb-4 inline-block text-7xl font-extrabold text-orange-500/20 sm:text-9xl">
            404
          </span>
    ...
    <template v-else>
      ...
      <!-- HERO / HEADER AREA                       -->
      <!-- ======================================== -->
      <section class="relative bg-base-100 pt-8 pb-16 sm:pt-12 sm:pb-24 md:pb-32 overflow-hidden">
        <!-- Glow decorations -->
        <div
          class="absolute -top-20 -left-20 h-48 w-48 rounded-full bg-orange-500/10 blur-[100px]"
        />
      ...
      <section class="bg-base-200 py-16 sm:py-24 md:py-32 overflow-hidden">
        <div class="container mx-auto px-5 sm:px-6 md:px-10 lg:px-16">
          ...
          >
            ...
            <div class="absolute -bottom-4 -right-2 text-orange-500/60 sm:-bottom-6 sm:-right-4">
              <svg class="h-16 w-16 sm:h-24 sm:w-24" viewBox="0 0 100 100" fill="currentColor">
        ...
        <div class="container relative z-10 mx-auto px-5 sm:px-6 md:px-10 lg:px-16">
          <div class="mx-auto max-w-4xl">
            ...
            >
              ...
              />
              <div
                class="prose prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-white prose-p:text-base-content/80 prose-p:leading-relaxed prose-a:text-orange-500 prose-a:no-underline hover:prose-a:underline prose-strong:text-white prose-ul:text-base-content/80 prose-ol:text-base-content/80 prose-li:text-base-content/80 prose-li:marker:text-orange-500 prose-code:text-orange-400 prose-code:bg-white/5 prose-code:rounded prose-code:px-1.5 prose-code:py-0.5 sm:text-lg"
      ...
      <section class="border-t border-base-content/10 bg-base-200">
        <div class="container mx-auto px-5 sm:px-6 md:px-10 lg:px-16">
          ...
          >
            ...
            <span class="text-xs font-semibold uppercase tracking-[0.2em] text-base-content/30">
